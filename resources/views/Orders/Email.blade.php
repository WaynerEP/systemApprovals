                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <img src="{{ $message->embed('public/assets/img/logo.png') }}"
                                                        width="30%" alt="Logo"> <a href="http://127.0.0.1:8000/home"
                                                        target="_blank" class="btn btn-primary">Mi cuenta ⎆</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div class="text-center mg-b-20"><a
                                                            href="{{ url('http://127.0.0.1:8000/orders/' . $idSolicitud . '/' . $dest->codEmpleado) }}"
